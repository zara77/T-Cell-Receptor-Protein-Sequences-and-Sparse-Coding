...
dataset_name = "sequences_100_pca"
seq_data = np.load("/alina-data1/Zara/TCell_Receptor/Embedding_Generation/" + dataset_name + ".npy")
#all_embeddings = np.load("/alina-data1/Zara/TCell_Receptor/concatenation_embeddings/all_embeddings.npy")

attribute_data = np.loadtxt("/alina-data1/Zara/TCell_Receptor/Embedding_Generation/Labels_100.npy", dtype=str)
